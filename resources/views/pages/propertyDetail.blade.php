...
@section('content')
    ...
    <div class="ltn__breadcrumb-area text-left bg-overlay-white-30 bg-image mb-0" data-bs-bg="{{ asset('img/bg/14.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="ltn__shop-details-inner ltn__page-details-inner mb-60">
                        ...
                        <p>Massa tempor nec feugiat nisl pretium. Egestas fringilla phasellus faucibus scelerisque eleifend
                            donec
                        ...
                        <div class="ltn__property-details-gallery mb-30">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="{{ asset('img/others/14.jpg') }}" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{ asset('img/others/14.jpg') }}" alt="Image">
                                    </a>
                                    <a href="{{ asset('img/others/15.jpg') }}" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{ asset('img/others/15.jpg') }}" alt="Image">
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{ asset('img/others/16.jpg') }}" data-rel="lightcase:myCollection">
                                        <img class="mb-30" src="{{ asset('img/others/16.jpg') }}" alt="Image">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ltn__video-bg-img ltn__video-popup-height-500 bg-overlay-black-50 bg-image mb-60"
                            data-bs-bg="{{ asset('img/others/5.jpg') }}">
                                ...
                                <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                    <div class="product-img">
                                        ...
                                        <div class="real-estate-agent">
                                            <div class="agent-img">
                                                <a href="team-details.html"><img src="{{ asset('img/blog/author.jpg') }}"
                                                        alt="#"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                        ...
                                        <div class="product-img-location">
                                            <ul>
                                                <li>
                                                    <a href="product-details.html"><i class="flaticon-pin"></i> Belmont
                                                        Gardens, Chicago</a>
                                                </li>
                                            </ul>
                                        </div>
                ...
                <div class="col-lg-4">
                    <aside class="sidebar ltn__shop-sidebar ltn__right-sidebar---">
                        ...
                        <div class="widget ltn__top-rated-product-widget">
                            ...
                            <ul>
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="{{ asset('img/product/1.png') }}"
                                                    alt="#"></a>
                                        </div>
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="{{ asset('img/product/2.png') }}"
                                                    alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            <div class="product-ratting">
                                ...
                                <li>
                                    <div class="top-rated-product-item clearfix">
                                        <div class="top-rated-product-img">
                                            <a href="product-details.html"><img src="{{ asset('img/product/3.png') }}"
                                                    alt="#"></a>
                                        </div>
                                        <div class="top-rated-product-info">
                                            <div class="product-ratting">
                        ...
                        <div class="widget ltn__popular-product-widget">
                            ...
                            <div class="row ltn__popular-product-widget-active slick-arrow-1">
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="{{ asset('img/product-3/6.jpg') }}"
                                                    alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="{{ asset('img/blog/author.jpg') }}"
                                ...
                                <div class="col-12">
                                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                                        <div class="product-img">
                                            <a href="product-details.html"><img src="{{ asset('img/product-3/5.jpg') }}"
                                                    alt="#"></a>
                                            <div class="real-estate-agent">
                                                <div class="agent-img">
                                                    <a href="team-details.html"><img src="{{ asset('img/blog/author.jpg') }}"
                        ...
                        <div class="widget ltn__popular-post-widget">
                            ...
                            <ul>
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{ asset('img/team/5.jpg') }}" alt="#"></a>
                                        </div>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{ asset('img/team/6.jpg') }}" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                    cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{ asset('img/team/7.jpg') }}" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                    cing elit, sed do.</a></h6>
                                ...
                                <li>
                                    <div class="popular-post-widget-item clearfix">
                                        <div class="popular-post-widget-img">
                                            <a href="blog-details.html"><img src="{{ asset('img/team/8.jpg') }}" alt="#"></a>
                                        </div>
                                        <div class="popular-post-widget-brief">
                                            <h6><a href="blog-details.html">Lorem ipsum dolor sit
                                                    cing elit, sed do.</a></h6>
                        ...
                        <div class="widget ltn__banner-widget d-none">
                            <a href="shop.html"><img src="{{ asset('img/banner/2.jpg') }}" alt="#"></a>
                        </div>
                    </aside>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row ltn__related-product-slider-two-active slick-arrow-1">
                ...
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            ...
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="team-details.html"><img src="{{ asset('img/blog/author.jpg') }}" alt="#"></a>
                                </div>
                            </div>
                        </div>
                        <div class="product-info">
                ...
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{ asset('img/product-3/4.jpg') }}" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="team-details.html"><img src="{{ asset('img/blog/author.jpg') }}" alt="#"></a>
                                </div>
                ...
                <div class="col-xl-6 col-sm-6 col-12">
                    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
                        <div class="product-img">
                            <a href="product-details.html"><img src="{{ asset('img/product-3/5.jpg') }}" alt="#"></a>
                            <div class="real-estate-agent">
                                <div class="agent-img">
                                    <a href="team-details.html"><img src="{{ asset('img/blog/author.jpg') }}" alt="#"></a>
                                </div>
