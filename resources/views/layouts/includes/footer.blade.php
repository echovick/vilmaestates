        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-about-widget" style="font-size:15px !important;">
                ...
                <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-menu-widget clearfix">
                        <h4 class="footer-title" style="font-size:20px;">Company</h4>
                        <div class="footer-menu" style="font-size: 15px">
                            <ul>
                                <li><a href="{{ url('about') }}">About</a></li>
                                <li><a href="{{ url('team') }}">The Team</a></li>
                                <li><a href="{{ url('blog') }}">Blog</a></li>
                                <li><a href="{{ url('portfolio') }}">All Products</a></li>
                                <li><a href="{{ url('our-locations') }}">Locations Map</a></li>
                ...
                <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-menu-widget clearfix">
                        <h4 class="footer-title" style="font-size:20px;">Services</h4>
                        <div class="footer-menu" style="font-size: 15px">
                            <ul>
                                <li><a href="{{ url('service/construction') }}">Construction</a></li>
                                <li><a href="{{ url('service/contracting') }}">Contracting</a></li>
                                <li><a href="{{ url('service/nvestment') }}">Investment</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-menu-widget clearfix">
                        <h4 class="footer-title" style="font-size:20px;">Customer Care</h4>
                        <div class="footer-menu" style="font-size: 15px">
                            <ul>
                                <li><a href="{{ url('faqs') }}">FAQ</a></li>
                                <li><a href="{{ url('contact') }}">Contact us</a></li>
                ...
                <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                    <div class="footer-widget footer-newsletter-widget">
                        <h4 class="footer-title" style="font-size:20px;">Newsletter</h4>
                        <p style="font-size: 15px">Subscribe to our weekly Newsletter and receive updates via email.</p>
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="ltn__copyright-design clearfix">
                        <p>All Rights Reserved @ Vilma Estates LTD <span class="current-year"></span></p>
                        <small>Design & Developed by <a href="#">Echo Digital Solutions</a></small>
                    </div>
                </div>
...
<!-- Maplace-active -->
<script src="{{ asset('js/maplace-active.js') }}"></script>
